  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-6 text-center">
        🐉 DRAGON Cybersecurity Analysis System
      </h1>
                    ...
                    {result.matches.map((m, i) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-slate-700 leading-relaxed whitespace-pre-wrap">
                          {m.text || "No abstract text available."}
                        </p>
                      </div>
                    ))}
                  </div>
                      ...
                      <p
                        className={`text-sm font-medium ${
                          result.analysis_summary.risk_level === "High"
                            ? "text-red-600"
                            : result.analysis_summary.risk_level === "Medium"
                              ? "text-yellow-600"
                              : "text-green-600"
                        }`}
                      >
                        {result.analysis_summary.risk_level}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-sm">
                        {result.analysis_summary.threat_categories.join(", ")}
                      </p>
                    </div>
                  </div>
                </div>
